...
public class ReportsAttendence extends AppCompatActivity {
    ...
    ReportsAttendenceFragments fragmentAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_reports_attendence);
        ...
        fragmentAdapter = new ReportsAttendenceFragments(fragmentManager, getLifecycle());
    ...
    protected void onPause() {
        super.onPause();
        ReportsAttendence.closeDrawer(drawerLayout);
    }
