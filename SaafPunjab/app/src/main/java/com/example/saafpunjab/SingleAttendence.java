...
public class SingleAttendence extends AppCompatActivity {
    ...
    SingleAttendenceFragments fragmentAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_single_attendence);
        ...
        fragmentAdapter = new SingleAttendenceFragments(fragmentManager, getLifecycle());
    ...
    protected void onPause() {
        super.onPause();
        SingleAttendence.closeDrawer(drawerLayout);
    }
