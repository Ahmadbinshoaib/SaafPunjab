...
public class ContainerTagging extends AppCompatActivity {
    ...
    ContainerTaggingFragments fragmentAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_container_tagging);
        ...
        fragmentAdapter = new ContainerTaggingFragments(fragmentManager, getLifecycle());
    ...
    protected void onPause() {
        super.onPause();
        ContainerTagging.closeDrawer(drawerLayout);
    }
